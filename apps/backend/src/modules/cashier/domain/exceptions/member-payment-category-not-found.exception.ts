...
// So dispara se a categoria de sistema "member_payment" (migration 0073) nao
// existir para a org — nunca deve acontecer em orgs criadas apos a 0073, mas
// e registro append-only (trigger da 0072 rejeita UPDATE): um pagamento
...
// (requisito do database-guardian, veredito da migration 0072). 422, nao
