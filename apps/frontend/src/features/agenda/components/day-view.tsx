...
export function DayView({
  ...
  return (
    <div className="rounded-xl border border-white/[0.06]">
      ...
      <div className="grid grid-cols-[64px_1fr] border-b border-white/[0.06]">
        <div className="flex items-center justify-end pr-2 text-[10px] uppercase text-white/30">
          Dia todo
        </div>
        <div className="min-h-[30px] space-y-1 border-l border-white/[0.06] p-1">
          {allDayEvents.map((ev) => (
            <button
              key={ev.id}
              type="button"
              ...
              className={cn(
                ...
                ev.type === "unavailability"
                  ? "bg-white/[0.06] text-white/50 [background-image:repeating-linear-gradient(45deg,transparent,transparent_6px,rgba(255,255,255,0.04)_6px,rgba(255,255,255,0.04)_12px)]"
            ...
            return (
              <button
                ...
                className={cn(
                  ...
                  isBusy
                    ? "border-white/10 bg-white/[0.06] text-white/50 [background-image:repeating-linear-gradient(45deg,transparent,transparent_6px,rgba(255,255,255,0.04)_6px,rgba(255,255,255,0.04)_12px)]"
