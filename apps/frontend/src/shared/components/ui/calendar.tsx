  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        button_previous: cn(
          d.button_previous,
          "inline-flex h-7 w-7 items-center justify-center rounded-md text-white/60 transition-colors hover:bg-white/10 hover:text-white",
        ),
        button_next: cn(
          d.button_next,
          "inline-flex h-7 w-7 items-center justify-center rounded-md text-white/60 transition-colors hover:bg-white/10 hover:text-white",
        ...
        weekday: cn(d.weekday, "w-9 text-[0.7rem] font-normal text-white/30"),
        week: cn(d.week, "mt-1 flex w-full"),
        day: cn(d.day, "h-9 w-9 p-0 text-center text-sm"),
        day_button: cn(
          d.day_button,
          "inline-flex h-9 w-9 items-center justify-center rounded-md font-normal text-white/80 transition-colors hover:bg-white/10",
        ),
        ...
        outside: cn(d.outside, "text-white/20"),
        disabled: cn(d.disabled, "text-white/10 opacity-50"),
